...
int main()
{
    ...
    vector<Objeto *> objetos = {&planoChao, &planoFrontal, &planoLateralDireita, &planoLateralEsquerda, &planoTeto, &cilindro, &cone, &esfera};
    ...
    ofstream arquivo("cena_com_malha.ppm");
    arquivo << "P3\n"
            << nCol << " " << nLin << "\n255\n";
    ...
    cout << "Imagem gerada em 'cena_com_malha.ppm'" << endl;
