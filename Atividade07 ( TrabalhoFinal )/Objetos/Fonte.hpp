...
struct Fonte : ObjetoComplexo
{
    Fonte()
    {
        ...
        Plano* aguaBase = new Plano(Ponto(0, hBase * 0.5f, 0), up, texAgua, 1.0f, 100, rIntBase);
        ...
        Plano* aguaMedia = new Plano(Ponto(0, yMedia - (rMedia * 0.4f), 0), up, texAgua, 2.0f, 100, rMedia * 0.9f);
        ...
        Cilindro* aroBordaTop = new Cilindro(Ponto(0, yTopo, 0), rTopo + 0.05f, rTopo - 0.05f, 0.1f, up, true, true, pedraKd, pedraKe, pedraKa, m_pedra);
